    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid gap-3 sm:gap-4">
        {filteredVocabs.map(vocab => (
          <div key={vocab.id} className="bg-gradient-to-br from-white to-blue-50 border-2 border-blue-200 rounded-lg p-3 sm:p-4 md:p-6 hover:border-blue-400 hover:shadow-lg transition-all">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              <div className="flex-1">
                <div className="flex items-baseline gap-2 mb-1">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-700">{vocab.term}</h3>
                  <span className="text-xs sm:text-sm text-gray-500 font-mono">({vocab.pronunciation})</span>
                </div>
                <p className="text-sm sm:text-base text-blue-600 font-medium">{vocab.korean}</p>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="bg-white border-l-4 border-blue-400 p-3 sm:p-4 rounded">
                <p className="font-semibold text-blue-700 mb-2 text-sm sm:text-base">📖 정의</p>
                <p className="text-gray-900 text-sm sm:text-base">{vocab.definition}</p>
              </div>

              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-orange-400 p-3 sm:p-4 rounded">
                <p className="font-semibold text-orange-700 mb-2 text-sm sm:text-base">🎯 실생활 비유</p>
                <p className="text-gray-900 text-sm sm:text-base">{vocab.analogy}</p>
              </div>

              <div className="bg-white border-l-4 border-green-400 p-3 sm:p-4 rounded">
                <p className="font-semibold text-green-700 mb-2 text-sm sm:text-base">💡 실제 예시</p>
                <p className="text-gray-900 text-sm sm:text-base">{vocab.example}</p>
              </div>

              <div className="bg-gray-50 p-3 sm:p-4 rounded">
                <div className="flex items-center justify-between mb-2">
                  <p className="font-semibold text-gray-900 text-sm sm:text-base">💻 코드 예시</p>
