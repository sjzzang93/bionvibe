...
export interface WithdrawalEncyclopediaData {
  version: string;
  scale: {
    severity: string[];
  };
...
export const WITHDRAWAL_ENCYCLOPEDIA_DATA: WithdrawalEncyclopediaData = {
  "version": "1.0.0",
  "scale": {
    "severity": ["경미", "보통", "심각"]
  },
  "symptoms": [
    ...
    },
    {
      ...
      "nonPharmacologic": ["명상 앱 5분", "따뜻한 차", "규칙적 수면 루틴"],
    ...
    },
    {
      ...
      "nonPharmacologic": ["카페인 과다 피하기", "규칙적 식사", "소음 줄이기"],
    ...
    },
    {
      ...
      "nonPharmacologic": ["걷기 20~30분", "프룬/요거트", "과도한 변비약 남용 금지"],
    ...
    },
    {
      ...
      "nonPharmacologic": ["감정 기록", "수면·영양 점검", "지지자에게 알리기"],
    ...
    },
    {
      ...
      "nonPharmacologic": ["카페인·매운 음식 줄이기"],
