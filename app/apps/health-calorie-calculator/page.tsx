    ...
    <div className="min-h-screen bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 py-8 px-4">
      <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4 pt-6">
              ...
              <div className="text-center">
                <a
                  ...
                  className="inline-block bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-bold text-sm md:text-lg hover:shadow-lg transition-all"
                >
                  🛒 건강식품/보조제 추천
                </a>
              </div>
        ...
        <div className="mt-8 text-center text-white/80 text-xs md:text-sm px-4">
          ...
          <p className="mt-2">본 페이지는 쿠팡 파트너스 활동을 통해 일정 수수료를 받을 수 있습니다.</p>
        </div>
      </div>
    </div>
  );
