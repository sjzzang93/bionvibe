  ...
  "crisisSituations": [
    {
      ...
      "immediate5MinActions": [
        {
          "action": "냉수 세수",
          "duration": "30초",
          "detail": "자극 전환으로 욕구 파도 약화"
        },
        {
          "action": "계단 오르내리기",
          "duration": "2분",
          "detail": "심박 상승으로 엔돌핀 분비"
        },
        {
          "action": "복식 호흡 10회",
          "duration": "1분",
      ...
      "successStories": [
        "A(45세): 욕구 올 때 5분 산책으로 3개월 완전 금연."
      ]
    },
    {
      "id": "c-02",
      ...
      "successStories": [
        "B: 업무 스트레스마다 4-7-8로 진정, 6개월 금연 유지."
      ]
    },
    {
      "id": "c-03",
